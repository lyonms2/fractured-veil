...
window.registerStrings({
  ...
  'mag.so_f2.desc':   'Não fere o corpo: desfaz o que havia dentro dele. O alvo testa Resistência e, falhando, sai do combate de vez. Um 6 falha sempre, por mais Resistência que ele tenha — e só a alma fechada trava isto. Custa quarenta: a reserva inteira de quem a tem, num só lançamento.',
  ...
  'mag.so_f2.desc':   'It does not wound the body: it unmakes what was inside it. The target tests Endurance and, on a failure, leaves combat for good. A 6 always fails, however much Endurance they have — and only a closed soul stops this. It costs forty: the entire reserve of whoever carries it, in a single cast.',
