...
window.registerStrings({
  ...
  // O que a esquiva passa a valer de fato, contra o inimigo que está à
  ...
  'mag.conta.armadura_dobra':'A ×2, exceto contra magia',
  'mag.conta.fd':            'FD +{n}',
  ...
  'ficha.sexo.M':     'Macho',
  'ficha.sexo.F':     'Fêmea',
  'ficha.vocacao':    'tende a {a} e {b}',
  'ficha.indole':     'índole de {i}',
  ...
  'repr.erro.mesmo':      'Um avatar não cruza consigo mesmo.',
  'repr.erro.morto':      'Um deles já partiu.',
  'repr.erro.avenda':     'Um deles está à venda no mercado.',
  'repr.erro.sem_dna':    'Um deles nasceu antes de haver DNA e não pode ter filhos.',
  'repr.erro.mesmo_sexo': 'Precisa de um macho e uma fêmea.',
  'repr.erro.novo':       'Os dois precisam de ser ADULTOS — nível e horas de jogo.',
  'repr.erro.cheio':      'A chocadeira está cheia — dez ovos é o máximo.',
  'repr.titulo':          '❦ CRUZAR',
  ...
  'indole.fonte.ex':  'Fonte — nasce para durar. Tende a magias baratas e a virtudes de reserva e cura.',
  ...
  'mag.conta.oculta':        'S ×2 on Defense',
  ...
  'mag.conta.vorpal':        'a critical that beats Defense can end the fight',
  ...
  'ficha.sexo.M':     'Male',
  'ficha.sexo.F':     'Female',
  'ficha.vocacao':    'leans toward {a} and {b}',
  'ficha.indole':     '{i} nature',
  ...
  'repr.erro.mesmo':      'An avatar cannot breed with itself.',
  'repr.erro.morto':      'One of them is gone.',
  'repr.erro.avenda':     'One of them is listed on the market.',
  'repr.erro.sem_dna':    'One of them was born before DNA existed and cannot have children.',
  'repr.erro.mesmo_sexo': 'You need one male and one female.',
  'repr.erro.novo':       'Both must be ADULTS — level and hours played.',
  'repr.erro.cheio':      'The incubator is full — ten eggs is the limit.',
  'repr.titulo':          '❦ BREED',
  ...
  'mag.te_d3.desc':   'Skin turns to living stone: your Armor counts double against anything that is not magic.',
  ...
  'mag.vt_f3.desc':   'The air around your hands turns to blade. No extra damage: the edge stays up and applies to any blow of yours, fists included. If the attack lands perfectly AND actually wounds, the target tests Armor and, on a failure, it ends there. A perfect hit fully absorbed cuts nothing - and a 6 always fails, however much Armor they have.',
  'mag.vt_d3.nome':   'Headwind',
  'mag.vt_d3.desc':   'A gale blowing into the face of whoever comes. Each MP invested is +1 to your Defense Force - against everyone, not just whoever stands there now. It charges that same amount every turn to keep blowing, and drops the moment it cannot.',
  ...
  'mag.fg_f1.desc':   'The air catches fire in blue and white flame. No armor is of any use.',
  ...
  'mag.fg_a5.desc':   'Flame orbs circling the target, bursting one per turn. No armor stops them.',
  'mag.fg_f2.nome':   'Eruption',
  'mag.fg_f2.desc':   'The ground opens beneath the target and vomits lava. No armor holds that back.',
  ...
  'mag.ag_d1.desc':   'A shell of living water closes around you. Each MP spent is worth 1 Armor, up to 5 — and it charges that same amount every turn to hold. Works against blows and magic alike, but not against what pierces armor.',
  'mag.ag_d2.nome':   'Dense Mist',
  'mag.ag_d2.desc':   'A closed fog rises off the water. On Defense your Skill counts double - it is worth as much as you are already nimble. It does not hamper your own attack, and it does not help you dodge: it hides, it does not sidestep.',
  ...
  'mag.te_d1.desc':   'Wood and vine sprout from the ground and wrap the body. Each MP spent is worth 1 Armor, up to 5 - and it charges that same amount every turn to hold. Works against blows and magic alike, but not against what pierces armor.',
  ...
  'mag.vt_a2.desc':   'A dry thunder fired from the hands. Blades of sound that pass through any armor.',
  'mag.vt_a3.nome':   'Gust',
  ...
  'mag.vt_d1.desc':   'A wall of wind closes around you. Adds 10 to your Defense Force - and, unlike every other defense, it is paid once and lasts the whole fight, charging nothing per turn.',
