...
(function () {
  const STRINGS = {
    ...
    pt: {
      ...
      'gs.tab.lore':             'LORE',
      // PVE
      'gs.memoria.name':         'ECOS DO VÉU',
      'gs.memoria.desc':         'Cada elemento deixa um eco. Encontre todos os pares.',
      'gs.mina.name':            'CAMPO MINADO',
      'gs.mina.desc':            'Revele o campo sem explodir as minas',
      'gs.simon.name':           'PULSO DA FRATURA',
      'gs.simon.desc':           'A Fratura pulsa uma sequência. Repita sem errar.',
      'gs.snake.name':           'RASTRO DE LUZ',
      'gs.snake.desc':           'Recolha os elementos e nunca cruze o próprio rastro.',
    ...
    en: {
      ...
      'gs.tab.lore':             'LORE',
      // PVE
      'gs.memoria.name':         'ECHOES OF THE VEIL',
      'gs.memoria.desc':         'Every element leaves an echo. Find all the pairs.',
      'gs.mina.name':            'MINESWEEPER',
      'gs.mina.desc':            'Clear the field without hitting mines',
      'gs.simon.name':           'PULSE OF THE FRACTURE',
      'gs.simon.desc':           'The Fracture beats out a sequence. Repeat it exactly.',
      'gs.snake.name':           'TRAIL OF LIGHT',
      'gs.snake.desc':           'Gather the elements and never cross your own trail.',
