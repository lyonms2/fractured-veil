...
(function () {
  const STRINGS = {
    ...
    pt: {
      ...
      // Um nome só tem um dono — ver js/nomes.js.
      'nomes.conferindo':  'CONFERINDO…',
      'nomes.err.tomado':  'Esse nome já é de alguém. Escolha outro.',
      'nomes.err.forma':   'Escreva pelo menos duas letras ou números.',
      'nomes.err.ja_batizado': 'Este avatar já foi batizado.',
      ...
      'ui.subtitulo':            '◆ CRIATURAS DO VÉU ◆',
      'id.sem_nome':             'Sem nome',
      'id.titulo.m':             'Guardião da Fenda',
      'id.titulo.f':             'Guardiã da Fenda',
      'id.sem_avatar':           'seu Avatar',
      'rename.marca':            '◈ BATIZADO',
      'rename.sugerir':          'Sugerir um nome',
    ...
    en: {
      ...
      // A name has a single owner — see js/nomes.js.
      'nomes.conferindo':  'CHECKING…',
      'nomes.err.tomado':  'That name is taken. Pick another one.',
      'nomes.err.forma':   'Type at least two letters or numbers.',
      'nomes.err.ja_batizado': 'This avatar has already been named.',
      'nomes.err.sem_avatar':  'We could not find that avatar in your colony.',
      'nomes.err.rede':    'Could not confirm the name right now. Try again.',
      ...
      'ui.subtitulo':            '◆ CREATURES OF THE VEIL ◆',
      'id.sem_nome':             'Unnamed',
      'id.titulo.m':             'Warden of the Rift',
      'id.titulo.f':             'Warden of the Rift',
      'id.sem_avatar':           'your Avatar',
      'rename.marca':            '◈ NAMING',
      'rename.sugerir':          'Suggest a name',
      'rename.btn_title':        'Name it — only once',
      'rename.nasceu_como':      'Born as',
      'rename.sem_nome_fratura': 'It crossed unnamed. For now it is just',
      'rename.sem_nome_ovo':     'It hatched unnamed. For now it is just',
