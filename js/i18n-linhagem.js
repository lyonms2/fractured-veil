...
window.registerStrings({
  ...
  'lin.registo_aviso':    'Este avatar já não está na sua colônia. O que se vê é o retrato guardado no dia em que o ovo foi posto — a certidão dele viajou com ele.',
  'lin.registo_titulo':   '◈ REGISTO',
  'lin.saiu':             'já não é seu',
  'lin.sexo':             'Sexo',
  ...
  'lin.registo_aviso':    'This avatar is no longer in your colony. What you see is the portrait kept on the day the egg was laid — its certificate travelled with it.',
