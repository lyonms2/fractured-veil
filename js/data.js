...
const CARACTERISTICAS_ELEMENTAIS = {
  'Fogo':         { bonus:'Espírito Ardente: humor decai 15% mais devagar, fome 10% mais rápido', ...
  'Água':         { bonus:'Serenidade das Marés: humor e higiene decaem 15% mais devagar', ...
  'Terra':        { bonus:'Raízes Profundas: fome decai 15% mais devagar', ...
  'Vento':        { bonus:'Leveza do Vento: energia decai 15% mais devagar', ...
  'Eletricidade': { bonus:'Mente Acelerada: energia decai 10% mais devagar, recupera 15% mais rápido dormindo', ...
  'Sombra':       { bonus:'Ciclo Lunar: higiene decai 10% mais devagar, recupera energia 15% mais rápido dormindo', ...
  'Luz':          { bonus:'Aura Solar: vínculo decai 20% mais devagar, humor 10% mais devagar', ...
  'Void':         { bonus:'Essência Vazia: fome e humor decaem 10% mais devagar, higiene 5% mais rápido', ...
  'Aether':       { bonus:'Potencial Infinito: todos os stats decaem 5% mais devagar', ...
};
