...
window.registerStrings({
  ...
  'mkt.slot.sem_venda.morto':  'Um avatar caído não pode ser vendido.',
  'mkt.origem.primordial':     'Primordial — veio de dentro da Fenda',
  'mkt.origem.cruza':          'Filho de {mae} e {pai}',
  'mkt.slot.sem_venda.doente': 'Um avatar doente não pode ser vendido. Trate a doença antes de vender.',
  ...
  'mkt.metamask.desvincular_curto': 'Desvincular mesmo?',
  ...
  'mkt.slot.sem_venda.morto':  'A fallen avatar cannot be sold.',
  'mkt.origem.primordial':     'Primordial — came from inside the Rift',
  'mkt.origem.cruza':          'Child of {mae} and {pai}',
  'mkt.slot.sem_venda.doente': 'A sick avatar cannot be sold. Treat the illness before selling.',
  ...
  'mkt.metamask.desvincular_curto': 'Really unlink?',
