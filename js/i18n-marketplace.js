...
window.registerStrings({
  ...
  'mkt.transp.eggs_body':      'Um ovo Raro ou Lendário tem duas saídas: <strong>vender à pool</strong>, a preço dinâmico — mais alto quando a pool está cheia — ou <strong>vender a outro jogador</strong> no mercado. Só a venda à pool tira cristais dela.',
  'mkt.transp.burn_label':     'QUEIMAR (só Comum · não toca na pool)',
  ...
  'mkt.transp.eggs_body':      'A Rare or Legendary egg has two exits: <strong>sell it to the pool</strong> at a dynamic price — higher when the pool is full — or <strong>sell it to another player</strong> on the market. Only the pool sale takes crystals out of the pool.',
  'mkt.transp.burn_label':     'BURN (Common only · pool untouched)',
