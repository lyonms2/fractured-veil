...
window.registerStrings({
  ...
  'mkt.origem.invocacao':      'Fundador — um dos três da invocação inicial',
  'mkt.origem.cruza':          'Filho de {mae} e {pai}',
  'mkt.origem.ovo':            'Chocado de um ovo',
  ...
  'mkt.origem.invocacao':      'Founder — one of the three from the first summoning',
  'mkt.origem.cruza':          'Child of {mae} and {pai}',
  'mkt.origem.ovo':            'Hatched from an egg',
