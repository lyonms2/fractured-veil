...
window.registerStrings({
  ...
  'mkt.transp.weekly_note':    'Mínimo garantido: <strong style="color:var(--text);">5%</strong> · Máximo: <strong style="color:var(--text);">20%</strong>. A taxa acompanha o tamanho da pool.',
  ...
  'mkt.transp.rarity_bonus':   '(+ bônus de raridade)',
  ...
  'mkt.transp.weekly_note':    'Guaranteed minimum: <strong style="color:var(--text);">5%</strong> · Maximum: <strong style="color:var(--text);">20%</strong>. The rate follows the size of the pool.',
