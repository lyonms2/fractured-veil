...
window.registerStrings({
  ...
  'mkt.transp.weekly_body':    'O desenvolvedor recebe <strong style="color:var(--text);">1% de cada resgate</strong>, e mais nada. Sai do que é sacado, como os bônus de convite — nunca da pool. Antes era uma fatia do saldo da pool toda semana, o que cobrava mesmo sem ninguém jogar e encolhia a garantia dos cristais de todo mundo.',
  ...
  'mkt.transp.weekly_body':    'The developer takes <strong style="color:var(--text);">1% of every redemption</strong>, and nothing else. It comes out of what is withdrawn, like referral bonuses — never from the pool. It used to be a slice of the pool balance every week, which charged even with nobody playing and shrank the backing of every crystal held.',
