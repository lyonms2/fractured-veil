...
window.registerStrings({
  ...
  'mkt.slot.empty_sub':       'Usa este slot\npara invocar',
  'mkt.slot.empty_active_sub':'Volta ao jogo\ne invoca aqui',
  ...
  'ficha.ultimate':           'O golpe forte escala com <b>{stat}</b>',
  'equipa.title':             '⚔ EQUIPA DE COMBATE',
  'equipa.pronta':            'Equipa pronta para batalhar.',
  'equipa.incompleta':        'Faltam {faltam} — escolhe nos cards abaixo.',
  'equipa.poder':             'Poder da equipa: <b>{poder}</b>',
  'equipa.btn_on':            '⚔ Na equipa',
  'equipa.btn_off':           '⚔ Pôr na equipa',
  'equipa.btn_listed':        '❄️ À venda',
  'equipa.btn_listed_title':  'Avatares à venda não podem batalhar.',
  'equipa.btn_full_title':    'A equipa já tem {max}. Tira um primeiro.',
  'equipa.toast.add':         '{nome} entrou na equipa.',
  'equipa.toast.remove':      '{nome} saiu da equipa.',
  'equipa.toast.cheia':       'A equipa já tem {max} avatares. Tira um primeiro.',
  ...
  'ficha.ultimate':           'The heavy attack scales with <b>{stat}</b>',
