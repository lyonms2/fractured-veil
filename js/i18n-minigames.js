...
window.registerStrings(
  // ── PORTUGUÊS ──────────────────────────────────────────────────
  {
    ...
    'mg.fus.parar':          'ENCERRAR E RECEBER',
    'mg.fus.nv.fratura':     'Fratura',
    'mg.fus.nv.veu':         'Véu',
    'mg.fus.nv.vacuo':       'Vácuo',
    'mg.fus.nv.avatar':      'Avatar',
    ...
    'mg.tet.dica':           '← → mover · ↑ girar · ↓ descer uma linha · espaço derrubar · C guardar · P pausar',
    'mg.tet.pausa':          'PAUSA',
    'mg.tet.continuar':      'SEGUIR',
    'mg.tet.pausado':        'PAUSADO',
    'mg.tet.retomar':        'toque no poço para continuar',
  ...
  // ── ENGLISH ────────────────────────────────────────────────────
  {
    ...
    'mg.fus.parar':          'CASH OUT',
    'mg.fus.nv.fratura':     'Fracture',
    'mg.fus.nv.veu':         'Veil',
    'mg.fus.nv.vacuo':       'Void',
    'mg.fus.nv.avatar':      'Avatar',
    'fus.rank.titulo':       '🏆 RANKING · {diff}',
    ...
    'mg.tet.nivel':          'LEVEL',
    'mg.tet.linhas':         'LINES',
    'mg.tet.dica':           '← → move · ↑ rotate · ↓ down one row · space hard drop · C hold · P pause',
    'mg.tet.pausa':          'PAUSE',
    'mg.tet.continuar':      'RESUME',
    'mg.tet.pausado':        'PAUSED',
    'mg.tet.retomar':        'tap the well to continue',
    'tet.rank.titulo':       '🏆 RANKING · {diff}',
