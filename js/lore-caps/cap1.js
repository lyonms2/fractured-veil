...
LORE_CAPITULOS.push({
  ...
  descricao:'2047. Três anos depois da 3ª Guerra Mundial. As bombas abriram Fraturas na realidade — e por elas vieram os Avatares. Mas também veio O Vácuo.',
  icone:    '☢️',
  raridade: 'Comum',
  anterior: null,
  cenas: {
    ...
    // ══════════════════════════════════════════════════
    inicio: {
      texto: '2047. Três anos depois das bombas.\n\nO céu nunca mais voltou a ser azul. É dessa cor agora — ferrugem oxidada, como se o mundo ainda estivesse sangrando para o horizonte. Sua cidade não tem nome, porque cidades sem sobreviventes perdem o direito a nomes.\n\nVocê está nos escombros do que deve ter sido um supermercado. Tem água para dois dias. Tem medo há três anos.\n\nA cinquenta metros, a Fratura pulsa.\n\nÉ a quarta que você vê essa semana — fendas abertas na realidade pelas explosões nucleares quando encontraram as linhas de falha dimensional. Os cientistas que sobreviveram as chamam de Fraturas do Véu. Os sobreviventes comuns chamam de portais, e preferem ignorá-las.\n\nVocê sempre achou que teria forças para ignorar quando chegasse a hora.\n\nE dessa Fratura... emerge algo.\n\nUma criatura pequena, feita de luz densa — [cor], e não há duas iguais. Olhos que parecem saber mais do que qualquer humano vivo. Ela olha diretamente para você — como se sempre soubesse que você estaria aqui.\n\nO contador de radiação no seu pulso bipta três vezes. Perto demais. Mas você não consegue se mover.',
      escolhas: [
    ...
    abertura_tatica: {
      texto: 'Você se move para o lado, não para frente.\n\nO Emissário, calibrado para resistência direta, perde um tempo para recalibrar. Nesse tempo [nome] age — não para atacar, mas para criar distância entre ele e a Fratura. Afastá-lo da origem.\n\nIsso importa. Você não sabe ainda por quê, mas a urgência com que ela fez isso não era aleatória. Afastar um Emissário da Fratura de onde emergiu é cortar a linha de reforço. Ela sabe isso. Você aprende observando.\n\nEle percebe a manobra. A forma se contrai — irritação, se irritação é possível em algo sem face.\n\nE num gesto que parece ao mesmo tempo uma punição e uma pergunta, ele pousa a ausência-de-mão na cabeça de [nome].\n\nEla não recua. Fecha os olhos.',
      escolhas: [
    ...
    // ══════════════════════════════════════════════════
    o_toque_no_nome: {
      texto: 'Quando ele toca [nome] — ou o que conta como toque para algo feito de ausência — o mundo para.\n\nNão metaforicamente.\n\nO contador de radiação no seu pulso congela num número. A poeira no ar fica estática, suspensa, como se alguém tivesse pausado a gravidade por cortesia. O som que o Emissário absorvia pára de desaparecer.\n\nTrês segundos de pausa total na física do local.\n\nDepois [nome] emite uma luz.\n\nNão é a cor dela — essa luz vem de mais fundo. De antes dela ter chegado aqui, de antes da Fratura, de antes das bombas. Uma luz que parece ter idade, que parece ter nome, que parece conhecer o Emissário do mesmo modo que vacinas conhecem doenças.\n\nEle recua como algo que tocou brasa.\n\nRápido. Definitivo.\n\nA Fratura começa a fechar — mas antes de ficar menor que um punho, algo cai através dela. Um objeto pequeno, escuro, que aterra no concreto entre você e [nome] com um som que não combina com o tamanho que tem.',
      escolhas: [
