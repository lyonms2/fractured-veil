// ── Capítulo II — As Outras Fraturas (Comum) ─────────────────────
LORE_CAPITULOS.push({
  id:       'outras_fracturas',
  titulo:   'Capítulo II — As Outras Fraturas',
  descricao:'O mapa que [nome] traçou no pó aponta para mais Fraturas. O Vácuo está crescendo — e outros sobreviventes também encontraram Avatares.',
  icone:    '🗺️',
  raridade: 'Comum',
  ...
  cenas: {
    ...
    estudar_o_mapa: {
      texto: 'Você se ajoelha.\n\nO mapa de [nome] é mais complexo do que pareceu à primeira vista. Os símbolos ao lado de cada Fratura não são decorativos — são classificações. Você reconhece o símbolo da Fratura de ontem entre eles, e ao lado dele, a linha dupla que ela havia marcado antes.\n\nDas outras três: uma tem o mesmo símbolo simples que as Fraturas "normais" do mapa de ontem. As outras duas têm marcações que você não conhece — uma em forma de espiral, uma em forma de ponto com irradiações saindo.\n\nVocê aponta para a espiral. Pergunta com o gesto.\n\n[nome] olha para onde você aponta. Depois para você. A expressão muda para algo que fica entre confirmação e custo — a cara de quem vai dizer uma coisa difícil e ainda está calibrando a versão mais compreensível dela.\n\nEla toca a espiral com uma pata. Depois desce e toca o objeto. Depois olha para cima — para a direção do prédio ao noroeste.\n\nO símbolo espiral está na direção do prédio ao noroeste.',
      escolhas: [
    ...
    a_sequencia_explica: {
      texto: 'Yasmin pega um pedaço de fio e liga os pontos do mapa combinado na ordem em que foram abertas — Renan guardou as datas de cada observação.\n\nO padrão é uma espiral. Não exatamente geométrica — tem variações, imprecisões, o tipo de imperfeição que torna uma linha num fenômeno natural ao invés de num artefato. Mas espiral. Fechando para dentro. Com um ponto central que ainda não tem Fratura marcada.\n\nO ponto central fica a quatro quilômetros ao sul.\n\nRenan olha o mapa e não diz nada por tempo longo. Depois: "Quando eu era militar, antes, reconhecia padrões de cerco. Esta espiral tem o mesmo DNA. Cada Fratura é uma posição. O centro é o objetivo."\n\nVocê entende antes de ele terminar: as Fraturas não são portais aleatórios abertos pela física esquecendo de si mesma. São uma estratégia.\n\n[nome] pousa a pata sobre o ponto central. Quente demais para o tamanho dela.\n\nEla conhece esse ponto.',
      escolhas: [
