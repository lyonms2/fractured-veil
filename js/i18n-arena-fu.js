...
window.registerStrings({
  ...
  'af.ag.voo':         'No ar',
  'af.ag.voo.ef':        'É imune a ataques corpo a corpo, magias podem atingi-lo normalmente',
  'af.ag.chao':        'No chão',
  'af.ag.chao.ef':       'Foi derrubado do ar, levanta-se ao final da rodada',
  'af.ag.crise.furia':   'Fúria da Crise ativa: o dano dele ignora resistências',
  'af.ag.crise.voo':     'Voo Baixo desligado: ataques corpo a corpo o alcançam',
  'af.ag.crise.nada':    'sem efeito extra: nenhuma vantagem dele depende da crise',
  ...
  'afv.voo_baixo.curto': 'Fica no ar; desce em crise ou ao sofrer dano de {tipo}',
  'afv.voo_baixo.curto_sem': 'Fica no ar; desce em crise',
  'afv.fonte_funda.curto': '+{n} PM máximos',
  'afv.veia_avida.curto': 'Recupera {n} PM ao sofrer dano',
  'afv.furia_da_crise.curto': 'Em crise, o dano dele ignora resistências',
  'afv.ultimo_suspiro.curto': 'Ao cair, causa {n} de dano de {tipo} a cada inimigo de pé',
  'afv.golpe_pesado.curto': '+{n} de dano no golpe comum',
  ...
  'af.ag.voo':         'Airborne',
  'af.ag.voo.ef':        'Immune to melee attacks; spells hit them normally',
  'af.ag.chao':        'Grounded',
  'af.ag.chao.ef':       'Knocked out of the air; gets up at the end of the round',
  'af.ag.crise.furia':   'Crisis Fury active: their damage ignores Resistances',
  'af.ag.crise.voo':     'Low Flight off: melee attacks can reach them',
  'af.ag.crise.nada':    'no extra effect: none of their advantages depend on Crisis',
  ...
  'afv.voo_baixo.curto': 'Stays airborne; lands in Crisis or when hit by {tipo}',
  'afv.voo_baixo.curto_sem': 'Stays airborne; lands in Crisis',
  'afv.fonte_funda.curto': '+{n} max MP',
  'afv.veia_avida.curto': 'Recovers {n} MP when damaged',
  'afv.furia_da_crise.curto': 'In Crisis, their damage ignores Resistances',
  'afv.ultimo_suspiro.curto': 'On falling, deals {n} {tipo} damage to every standing enemy',
  'afv.golpe_pesado.curto': '+{n} damage on the basic strike',
