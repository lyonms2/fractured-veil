...
window.registerStrings({
  ...
  'af.orbe.guardar_rep.pm':    'de novo: ⅓ dano · +{n} PM',
  'af.orbe.guardar_rep.cheio': 'de novo: ⅓ dano',
  'af.orbe.guardar_ms.pm':     'morte súbita: não protege · +{n} PM',
  'af.orbe.guardar_ms.cheio':  'morte súbita: não protege',
  ...
  'af.lance.usa':     '{nome} · {magia} → {alvo}',
  'af.lance.contra_def': '{r} contra Defesa {dl}',
  'af.lance.contra_mag': '{r} contra Defesa Mágica {dl}',
  ...
  'af.ef.todos':      'em todos os inimigos, sem rolar',
  'af.ef.dano':       '{a}–{b} de dano',
  'af.ef.dano_fixo':  '{n} de dano',
  'af.ef.estado_sempre':  'deixa {e}',
  'af.ef.estado_critico': '{e} no crítico',
  'af.ef.ignora':     'ignora resistências',
  'af.ef.estilo.guarda':      'e fica em guarda',
  'af.ef.estilo.lamina':      'fura a guarda',
  'af.ef.estilo.sustentacao': 'e cura o aliado mais ferido',
  'af.ef.cura':       'cura {n} de um aliado',
  'af.ef.cura_varios':'cura {n} de até {a} aliados',
  'af.ef.limpa':      'tira um estado',
  'af.ef.concha':     'resiste aos elementos dos inimigos',
  'af.ef.barreira':   'Defesas no mínimo 12 · até 3 aliados',
  'af.ef.proteger':   'recebe os golpes contra um aliado',
  'af.ef.despertar':  '+6 de dano nos ataques de um aliado · não gasta o turno · 1× por luta',
  'af.bloq.ativa':    'o efeito já está ativo em todos',
  'af.bloq.ativa_si': 'o efeito já está ativo',
  'af.bloq.cheio':    'ninguém precisa agora',
  'af.bloq.usada':    'já usada nesta luta',
  'af.bloq.si':       'não pode ser em si mesmo',
  'af.alvo.nota.qualquer': 'esta magia alcança qualquer inimigo',
  'af.alvo.nota.varios':   'acerta até {n}: escolha um ou todos · {pm} PM cada',
  'af.alvo.nota.mover':    'o da frente protege os de trás',
  'af.alvo.nota.examinar': 'revela a vida e a ficha do inimigo',
  ...
  'af.lance.guarda_rep': 'guarda repetida: corta só um terço',
  ...
  'af.lance.morte_subita': '— rodada {n}: MORTE SÚBITA · a guarda não protege mais e as curas valem a metade —',
  'af.morte_subita':  'Morte súbita',
  ...
  'af.lance.exame.2':      'descobriu as afinidades, a fraqueza e as defesas',
  'af.lance.exame.3':      'descobriu tudo: magias e regras especiais',
  'af.vs.oculto':          'Ainda não se sabe como {tipo} afeta este inimigo: examine ou acerte um golpe para descobrir.',
  'af.b.examinar':         'Examinar',
  'af.b.examinar.ef':      'Rola PER + PER e revela o inimigo conforme o resultado: com 7 ou mais, vida, PM, feitio e atributos; com 10 ou mais, afinidades, fraqueza e defesas; com 13 ou mais, ou no crítico, magias e regras especiais.',
  'af.oculto.titulo':      'O que se sabe deste inimigo',
  'af.oculto.faixa.1':     '7 ou mais: vida, PM, feitio e atributos',
  'af.oculto.faixa.2':     '10 ou mais: afinidades, fraqueza e defesas',
  'af.oculto.faixa.3':     '13 ou mais: magias e regras especiais',
  'af.oculto.como':        'Use Examinar para descobrir mais. Cada golpe que acerta também revela a afinidade daquele tipo.',
  'af.oculto.descobertas': 'Descoberto nos golpes:',
  ...
  // Os laços entre avatares (js/lacos.js): a seção da ficha, o botão e o registro.
  'af.sec.lacos':       'LAÇOS',
  'af.laco.vazio':      'Nenhum laço ainda. Avatares que terminam batalhas juntos criam laços: ★ com 10 pontos, ★★ com 30, ★★★ com 60.',
  'af.laco.pontos':     '{p}{prox} pontos',
  'af.laco.longe':      'longe desta colônia',
  'af.laco.lembranca':  'lembrança',
  'af.laco.sem_nome':   'Sem nome',
  'af.laco.par.mae':    'mãe',
  'af.laco.par.pai':    'pai',
  'af.laco.par.filho':  'filhote',
  'af.lance.reencontro': 'reencontro com {nome} +{n}',
  'af.reencontro.aviso': '💔 {a} e {b} já lutaram lado a lado. Conhecem-se: as fichas estão abertas, e cada um bate melhor no outro (+{n}).',
  'af.laco.botao':      'Lutar pelo Laço +{n}',
  'af.laco.botao.dica': 'Uma vez por batalha: +{n} de precisão na próxima ação que rolar dado, pelo laço com {nome}.',
  'af.laco.subiu':      'Laço {estrelas} entre {a} e {b}!',
  'af.lance.laco':      'pelo laço com {nome} +{n}',
  'af.b.laco':          'Lutar pelo Laço',
  'af.b.laco.uma':      'Uma vez por batalha',
  'af.b.laco.alvo':     'Um aliado de pé',
  'af.b.laco.ef':       'Soma à precisão de uma ação (golpe, magia de ataque ou Examinar) o nível do maior laço com um aliado de pé: ★ +1, ★★ +2, ★★★ +3. Os laços crescem terminando batalhas juntos: 2 pontos pela vitória, 1 pelo resto, até 6 por dia para cada par. Pais e filhotes já nascem com ★.',
  ...
  'af.b.ef.danoMais':    'Todos os ataques do alvo causam +{n} de dano até o fim da luta. Não gasta o turno de quem lança, e só se lança uma vez por luta.',
  'af.ag.despertar.ef':  '+{n} de dano em todos os ataques',
  'af.lance.despertar':  '+{n} de dano até o fim da luta',
  ...
  'af.orbe.guardar_rep.pm':    'again: ⅓ damage · +{n} MP',
  'af.orbe.guardar_rep.cheio': 'again: ⅓ damage',
  'af.orbe.guardar_ms.pm':     'sudden death: no protection · +{n} MP',
  'af.orbe.guardar_ms.cheio':  'sudden death: no protection',
  'af.orbe.voltar':   'Back',
  'af.fechar':        'Close',
  'af.orbe.todos':    'All',
  'af.pm':            '{n} MP',
  ...
  'af.lance.usa':     '{nome} · {magia} → {alvo}',
  'af.lance.contra_def': '{r} vs Defense {dl}',
  'af.lance.contra_mag': '{r} vs Magic Defense {dl}',
  ...
  'af.ef.todos':      'on every enemy, no roll',
  'af.ef.dano':       '{a}–{b} damage',
  'af.ef.dano_fixo':  '{n} damage',
  'af.ef.estado_sempre':  'leaves them {e}',
  'af.ef.estado_critico': '{e} on a critical',
  'af.ef.ignora':     'ignores resistances',
  'af.ef.estilo.guarda':      'and takes guard',
  'af.ef.estilo.lamina':      'breaks through guard',
  'af.ef.estilo.sustentacao': 'and heals the most wounded ally',
  'af.ef.cura':       'heals an ally for {n}',
  'af.ef.cura_varios':'heals up to {a} allies for {n}',
  'af.ef.limpa':      'removes one condition',
  'af.ef.concha':     'resists the enemies\' elements',
  'af.ef.barreira':   'Defenses at least 12 · up to 3 allies',
  'af.ef.proteger':   'takes the hits aimed at an ally',
  'af.ef.despertar':  '+6 damage on an ally\'s attacks · does not use the turn · once per fight',
  'af.bloq.ativa':    'the effect is already active on everyone',
  'af.bloq.ativa_si': 'the effect is already active',
  'af.bloq.cheio':    'no one needs it right now',
  'af.bloq.usada':    'already used this fight',
  'af.bloq.si':       'cannot target itself',
  'af.alvo.nota.qualquer': 'this spell reaches any enemy',
  'af.alvo.nota.varios':   'hits up to {n}: pick one or all · {pm} MP each',
  'af.alvo.nota.mover':    'the one in front protects those behind',
  'af.alvo.nota.examinar': 'reveals the enemy\'s health and sheet',
  ...
  'af.lance.guarda_rep': 'repeated guard: cuts only a third',
  ...
  'af.lance.morte_subita': '— round {n}: SUDDEN DEATH · guarding no longer protects and healing is halved —',
  'af.morte_subita':  'Sudden death',
  ...
  'af.lance.exame.2':      'learned affinities, weakness and defenses',
  'af.lance.exame.3':      'learned everything: spells and special rules',
  'af.vs.oculto':          'It is not yet known how {tipo} affects this enemy: examine it or land a blow to find out.',
  'af.b.examinar':         'Examine',
  'af.b.examinar.ef':      'Rolls INS + INS and reveals the enemy by the result: 7 or more, HP, MP, bent and attributes; 10 or more, affinities, weakness and defenses; 13 or more, or a critical, spells and special rules.',
  'af.oculto.titulo':      'What is known about this enemy',
  'af.oculto.faixa.1':     '7 or more: HP, MP, bent and attributes',
  'af.oculto.faixa.2':     '10 or more: affinities, weakness and defenses',
  'af.oculto.faixa.3':     '13 or more: spells and special rules',
  'af.oculto.como':        'Use Examine to learn more. Every blow that lands also reveals the affinity to that type.',
  'af.oculto.descobertas': 'Learned from blows:',
  ...
  'af.sec.lacos':       'BONDS',
  'af.laco.vazio':      'No bonds yet. Avatars that finish battles together form bonds: ★ at 10 points, ★★ at 30, ★★★ at 60.',
  'af.laco.pontos':     '{p}{prox} points',
  'af.laco.longe':      'away from this colony',
  'af.laco.lembranca':  'memory',
  'af.laco.sem_nome':   'Unnamed',
  'af.laco.par.mae':    'mother',
  'af.laco.par.pai':    'father',
  'af.laco.par.filho':  'offspring',
  'af.lance.reencontro': 'reunion with {nome} +{n}',
  'af.reencontro.aviso': '💔 {a} and {b} once fought side by side. They know each other: the sheets are open, and each one hits the other harder (+{n}).',
  'af.laco.botao':      'Fight for the Bond +{n}',
  'af.laco.botao.dica': 'Once per battle: +{n} accuracy on the next action that rolls dice, for the bond with {nome}.',
  'af.laco.subiu':      'Bond {estrelas} between {a} and {b}!',
  'af.lance.laco':      'for the bond with {nome} +{n}',
  'af.b.laco':          'Fight for the Bond',
  'af.b.laco.uma':      'Once per battle',
  'af.b.laco.alvo':     'One standing ally',
  'af.b.laco.ef':       'Adds to the accuracy of one action (strike, attack spell or Examine) the level of the strongest bond with a standing ally: ★ +1, ★★ +2, ★★★ +3. Bonds grow by finishing battles together: 2 points for a win, 1 otherwise, up to 6 a day per pair. Parents and offspring start at ★.',
  ...
  'af.b.ef.danoMais':    "All of the target's attacks deal +{n} damage until the end of the fight. It does not use the caster's turn, and can be cast once per fight.",
  'af.ag.despertar.ef':  '+{n} damage on every attack',
  'af.lance.despertar':  '+{n} damage until the end of the fight',
